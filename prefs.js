...
function addDropDown(settings, group,setting1,labelstring,options,labeltooltip,width=105){
	return addDropDownsList(settings, group, [setting1], labelstring, [options], labeltooltip,width);
}
